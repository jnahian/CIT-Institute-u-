...
?>
	...
	<section>
		<div class="container marB20">
			...
			<div class="tGraphics">
				<div class="col-md-3 pd0">
                   <iframe class="img-responsive" src="//www.youtube.com/embed/igjIxbFOtxU" frameborder="0" ></iframe>
				</div>
                <div class="col-md-3 pd0">
                   <iframe class="img-responsive" src="https://www.youtube.com/embed/igjIxbFOtxU" frameborder="0" allowfullscreen></iframe>
				</div>
                <div class="col-md-3 pd0">
                   <iframe class="img-responsive" src="https://www.youtube.com/embed/igjIxbFOtxU" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<div class="container marB20">
            ...
            <div class="tGraphics ">
                <div class="col-md-3 pd0">
                    <a href="" id="video" data-toggle="modal" data-target=".video">
